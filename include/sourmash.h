...
uint8_t *nodegraph_to_buffer(Nodegraph *ptr, bool compressed, uintptr_t *size);
...
uint8_t *signatures_save_buffer(Signature **ptr, uintptr_t size, bool compressed, uintptr_t *osize);
